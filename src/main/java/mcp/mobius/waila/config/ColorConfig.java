...
public class ColorConfig {
    ...
    private static final ColorConfig DEFAULT_VANILLA = new ColorConfig(
            "cfg.theme.vanilla",
            null,
            null,
            null,
            null);
    private static final ColorConfig DEFAULT_DARK = new ColorConfig(
            "cfg.theme.dark",
            Color.decode("#131313"),
            Color.decode("#383838"),
            Color.decode("#242424"),
            null);
    private static final ColorConfig DEFAULT_ACHIEVEMENT = new ColorConfig(
            "cfg.theme.achievement",
            Color.decode("#212121"),
            Color.decode("#555555"),
            Color.decode("#555555"),
            null);
    ...
    public static void init() {
        try {
            if (!Waila.themeDir.exists() && Waila.themeDir.mkdirs()) {
                ...
                String achievementJson = OverlayConfig.GSON.toJson(DEFAULT_ACHIEVEMENT);
                FileWriter achievementWriter = new FileWriter(new File(Waila.themeDir, "achievement.json"));
                achievementWriter.write(achievementJson);
