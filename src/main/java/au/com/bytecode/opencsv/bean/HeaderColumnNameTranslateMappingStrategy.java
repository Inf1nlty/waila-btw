...
/* loaded from: Waila_1.5.2a.jar:au/com/bytecode/au.com.bytecode.opencsv/bean/HeaderColumnNameTranslateMappingStrategy.class */
public class HeaderColumnNameTranslateMappingStrategy<T> extends HeaderColumnNameMappingStrategy<T> {
    private Map<String, String> columnMapping = new HashMap();

    @Override // au.com.bytecode.au.com.bytecode.opencsv.bean.HeaderColumnNameMappingStrategy
